...
const userData: UserData = {
  privateData: new Redacted("user@example.com"),
};

console.log(userData);
console.log(userData.privateData.exposeSecret());

console.log(JSON.stringify(userData));

const easilySerializableUserData = {
  privateData: new Redacted("user@example.com", {
    "redactedOnJsonStringify": false,
  }),
};
console.log(JSON.stringify(easilySerializableUserData));
